...
>
> I recommend using a version manager for Node.js, such as `nvm` or `asdf`. This will allow you to easily switch between different versions of Node.js, which is useful when working on multiple projects with different requirements.

### Additional dependencies

* **ripgrep**: Usually included with Claude Code. If search functionality fails, see [search troubleshooting](../../chapter-3-advanced-features-and-sdk/10-troubleshooting.md#search-and-discovery-issues).
...
<Warning>
  ...
  If you encounter permission errors, see [configure Claude Code](../../chapter-3-advanced-features-and-sdk/10-troubleshooting.md#linux-permission-issues) for recommended solutions.
</Warning>
...
If you encounter any issues during installation, consult the [troubleshooting guide](../../chapter-3-advanced-features-and-sdk/10-troubleshooting.md#linux-permission-issues).
...
For details on running Claude Code on AWS or GCP, see [third-party integrations](../../chapter-3-advanced-features-and-sdk/8-deployment.md).
...
Set the `DISABLE_AUTOUPDATER` environment variable in your shell or [settings.json file](5-basic-configuration.md):
