...
<Tip>
  ...
  * Check the [subagents documentation](5-subagents.md) for detailed examples
</Tip>
...
You can also run a query in Plan Mode directly with `-p` (i.e., in ["headless mode"](../../chapter-3-advanced-features-and-sdk/4-headless-mode.md)):
...
See [settings documentation](../../chapter-6-configuration/1-settings.md#available-settings) for more configuration options.
...
<Steps>
  ...
  <Step title="Reference MCP resources">
    ...
    This fetches data from connected MCP servers using the format @server:resource. See [MCP resources](6-mcp.md#use-mcp-resources) for details.
  </Step>
</Steps>
...
For more details, see the [Slash commands](../../chapter-7-reference/3-slash-commands.md) reference page.
