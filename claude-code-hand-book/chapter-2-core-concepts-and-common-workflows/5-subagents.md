...
Subagents can be granted access to any of Claude Code's internal tools. See the [tools documentation](../../chapter-6-configuration/1-settings.md#tools-available-to-claude) for a complete list of available tools.
...
* [Slash commands](2-slash-commands.md) - Learn about other built-in commands
* [Settings](../../chapter-6-configuration/1-settings.md) - Configure Claude Code behavior
* [Hooks](../../chapter-3-advanced-features-and-sdk/1-hooks.md) - Automate workflows with event handlers