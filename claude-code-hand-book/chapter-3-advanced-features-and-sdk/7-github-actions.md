...
<Note>
  ...
  SDK](3-sdk-overview.md), which enables programmatic integration of
...
<Note>
  * You must be a repository admin to install the GitHub app and add secrets -
    ...
    Bedrock & Google Vertex AI](#using-with-aws-bedrock--google-vertex-ai)
    section.
</Note>
