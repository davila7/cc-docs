...
to run without approval using the `/permissions` command. See [Permissions docs](../../chapter-1-getting-started/4-authentication.md#configuring-permissions).
...
Then set `USE_BUILTIN_RIPGREP=0` in your [environment](../../chapter-6-configuration/1-settings.md#environment-variables).
...
For additional JetBrains configuration tips, see our [IDE integration guide](../../chapter-1-getting-started/5-basic-configuration.md#jetbrains-plugin-settings).
...
2. **Use post-processing hooks**: Set up automatic formatting hooks to detect and add missing language tags. See the [markdown formatting hook example](1-hooks.md#markdown-formatting-hook) for implementation details.
...
3. **Specify formatting preferences**: Include formatting requirements in your prompts or project [memory](../../chapter-2-core-concepts-and-common-workflows/4-memory-management.md) files.
...
* **Use project conventions**: Document your preferred markdown style in [CLAUDE.md](../../chapter-2-core-concepts-and-common-workflows/4-memory-management.md)
